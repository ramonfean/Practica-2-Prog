...
while not cola_admision.is_empty():
    ...
    if (contador_tiempo._tiempo -1) % 3 == 0:
        contador_tiempo.asignar_cola(cola_admision.dequeue())
    if cola_general_no_urgente.prioridad_paciente():
        contador_tiempo.cambiar_prioridad(cola_general_no_urgente.prioridad_paciente())
    if cola_especialidad_no_urgente.prioridad_paciente():
        contador_tiempo.cambiar_prioridad(cola_especialidad_no_urgente.prioridad_paciente())
